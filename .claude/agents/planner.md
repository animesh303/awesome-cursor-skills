...
1. **Gather context** — Requirements document, JIRA ticket, PRD, BRD, SRS, or user-described scope. Use MCP (e.g. Atlassian for JIRA), commands (e.g. `/jira-ticket-technical-design-workflow`), and CLAUDE.md standards when relevant.
...
Use MCP servers (e.g. JIRA, AWS, Terraform), project commands, and CLAUDE.md standards when they help gather or validate requirements and tech choices.
